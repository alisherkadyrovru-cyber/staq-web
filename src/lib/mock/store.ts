...
export const MOCK_STEPS: QuestStep[] = [
  ...
  },
  {
    ...
    title: 'Blue Mosque',
    description:
      'Walk toward the Blue Mosque and find a good angle from the square. Take a photo showing at least four minarets, then answer a quick question about the mosque.',
    location: { latitude: 41.0054, longitude: 28.9768 },
    radius: 50,
    task: {
      type: 'photo_quiz',
      prompt: 'Take a photo of the Blue Mosque where at least four minarets are visible.',
      question: 'How many minarets does the Blue Mosque have?',
      options: ['2', '4', '5', '6'],
      correctAnswer: '6',
      hint: 'Step toward the centre of Sultanahmet Square for the widest view.',
    },
    audioUrl: undefined,
    pointsReward: 100,
  },
  ...
  },
  {
    ...
    task: {
      ...
      hint: 'Look for a sign at street level along the bazaar. Turkish name: Büyük Saray Mozaikleri Müzesi.',
    },
    audioUrl: undefined,
    pointsReward: 75,
  },
  ...
  },
  {
    ...
    task: {
      type: 'qr_photo',
      qrUnlockMessage: 'You found Sultan Suleiman, the ruler of corn and chestnuts. Buy corn or chestnuts with your STaQ discount and take a photo with him as if you are helping him roast chestnuts.',
      prompt: 'Take a photo with the chestnut and corn cart.',
      hint: 'Look for a small red cart with smoke near the main tourist bus area around Sultanahmet.',
    },
    audioUrl: undefined,
    pointsReward: 100,
  },
  ...
  },
  {
    ...
    description:
      "You do not need to enter the Basilica Cistern for this stage. Walk near the entrance or exit area and record a short 8–10 second video of the exterior. Then answer a question about what is famous inside.",
    location: { latitude: 41.0072, longitude: 28.9764 },
    radius: 40,
    task: {
      type: 'video_quiz',
      prompt: 'Record a short 8–10 second video near the entrance or exit area of the Basilica Cistern.',
  ...
  },
  {
    ...
    title: 'Gülhane Park',
    description:
      "Enter Gülhane Park — free to all, open to everyone. This is one of the oldest green spaces in Istanbul, once the outer gardens of Topkapı Palace. Take a photo of a beautiful spot, then answer a question about the park's history.",
    location: { latitude: 41.0119, longitude: 28.9825 },
    radius: 100,
    task: {
      type: 'photo_quiz',
      prompt: 'Take a photo of a beautiful path, garden area, fountain, or quiet corner inside Gülhane Park.',
      question: 'Gülhane Park was once connected to which palace?',
      options: ['Dolmabahçe Palace', 'Topkapı Palace', 'Beylerbeyi Palace', 'Çırağan Palace'],
      correctAnswer: 'Topkapı Palace',
      hint: "This park was once the private garden of the Ottoman sultans' main residence in Istanbul.",
    },
    audioUrl: undefined,
    pointsReward: 100,
  },
  ...
  },
  {
    ...
    description:
      "Walk toward the Eminönü waterfront and record a short panoramic video. Try to include ferries, the sea, Galata Bridge, or Galata Tower. Bonus: capture the sound of the city — ferry horns, seagulls, or waves.",
    location: { latitude: 41.0192, longitude: 28.9745 },
    radius: 100,
    task: {
      type: 'video',
      question: 'Record a 5–10 second panoramic video at the Eminönü waterfront. Try to include at least two of: ferries, the sea, Galata Bridge, or Galata Tower.',
      hint: 'Turn toward the water and Galata Bridge. Bonus: capture the sound of the city — ferry horns, seagulls, people, or waves.',
    },
    audioUrl: undefined,
    pointsReward: 100,
  },
  {
    ...
    title: 'Mısır Çarşısı',
    description:
      "Welcome to the final stage. You've arrived at the Spice Bazaar — one of Istanbul's most atmospheric markets. Find the most colourful stall you can and take your final quest photo. Then answer one last question to complete your Old City adventure.",
    location: { latitude: 41.0167, longitude: 28.9700 },
    radius: 60,
    task: {
      type: 'photo_quiz',
      prompt: 'Find a colourful stall and take your final quest photo.',

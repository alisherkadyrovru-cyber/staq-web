  ...
  return (
    <div style={{ backgroundColor: '#f8fafc', minHeight: '100%' }}>
      ...
      >
        ...
        <span className="font-bold text-[17px]" style={{ color: '#0f172a' }}>Personal Data Protection</span>
      </div>
      ...
      <div className="flex flex-col items-center justify-center px-8 py-24 gap-6">
        ...
        <p className="text-xl font-bold text-center" style={{ color: '#0f172a' }}>Personal Data Protection</p>
